...
#     temporary files rather than use parameter expansion to avoid misinterpretation.
#   * Put the options into a file so that Gradle can read them in its own
#     startup script. This is a little fragile: it requires that the options
